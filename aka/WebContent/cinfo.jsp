...
<link href="/aka/style/cinfo.css" rel="stylesheet" type="text/css">
	...
	<div class="outer">
		...
		<div class="papa">
			<TABLE width=100%> 
				...
				<tr><td><div class="line"><div class="category">Customer ID:</div><div class="info">${empty a1 ? '' :a1}</div></div></td></tr>
